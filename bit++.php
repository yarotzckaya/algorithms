...
foreach($lines as $line) {
	...
	$line = trim($line);		
	/* хз почему, но это как-то сработало. Идея заюзать trim() пришла спонтанно - обнаружилось, что в строке каким-то чудом оказывается больше символов, чем вводит пользователь. Я предположина, что это могут быть 
	2 пробела и убрала их тримом. сработало (ТЮКА - Типичный Юлианский Комментарий)
	*/
	if(($line == '++X') | ($line == 'X++')){
		$x++;
	} else {
